...
<link type="text/css" rel="stylesheet" media="all" href="/test1/js/examples.css">
<script src="/test1/js/handlebars.js"></script>
<script src="/test1/js/jquery-1.10.2.min.js"></script>
<script src="/test1/js/typeahead.bundle.js"></script>
<script src="/test1/js/examples.js"></script>
        ...
        <form method="post" name="form_new" action="<?php echo $editFormAction; ?>">
          <tr bordercolor="#CCCCCC">
            <td height="40" valign="bottom">
              <span class="yb_standard_small">&nbsp;&nbsp;Can't find your name?: Create <a href="<?php echo $page_edit_contact; ?>?contact_id=new_contact&shop_id=<?php echo $shop_id?>">New User</a><br>&nbsp;&nbsp;Hint: Type in your first and last name with a space in between.</span>
...
<div class="searchBox example example-films">
...
<input type=text id=contact_id name=contact_id>
		  ...
		  <td valign="bottom"><input name="Submit" type="submit" disabled id="add_button" value="Sign In" /></td>
		  <td valign="bottom">&nbsp;</td>
	    </tr>
        ...
        <form method="post" name="FormUpdate_<?php echo $row_Recordset1['shop_visit_id']; ?>" action="<?php echo $editFormAction; ?>">
          ...
          <tr bordercolor="#CCCCCC" bgcolor="#CCCC33">
            <td colspan="6"><table border="0" cellspacing="0" cellpadding="1">
              ...
              <td><?php 
              if($shop_type == "Mechanic Operation Shop") 
			  	{list_projects_mechanics('project', $row_Recordset1['project_id']);}
			  else if($shop_type == "Open Shop" OR $shop_type == "Volunteer Shop")
			  	{list_projects('project', $row_Recordset1['project_id']);}
			  else 
			  	{list_projects_collective('project', $row_Recordset1['project_id']);}
               ?></td>
            </tr>
              <tr>
