...
$registration->owner_phone_home = $_POST['owner_phone_home'];
$registration->owner_phone_cell = $_POST['owner_phone_cell'];
$registration->owner_phone_work = $_POST['owner_phone_work'];
$registration->owner_DOB = $_POST['owner_DOB'];
$registration->genderType($_POST['owner_gender_type']);  //NOTE: This is a function.
$registration->owner_email = $_POST['owner_email'];
  ...
  <tr>
    <td align="center">
      ...
      <form method="post" id="form" name="form" class="form" onsubmit="return validate(this)" action="<?php echo $editFormAction; ?>" autocomplete="off">
		...
		<td><img src="media/system/images/bike_reg_sticker.jpg" alt="salt_lake_county_bicycle_registration_sticker" /><br /><input type="text" id="registration_number" name="registration_number" value="<?php echo $registration->registration_number; ?>" size="25" autocomplete="off" /> <font color="red">*</font><input type="submit" name="search" id="search" value="Find Exisiting Bike Info" /><br />You must include the red "T"</td>
		  </tr>
          <tr valign="baseline">
          ...
          <tr valign="baseline" class="odd">
			...
			<td><input type="text" id="owner_phone_home" name="owner_phone_home" value="<?php echo $registration->owner_phone_home; ?>" size="25" /> <font color="red">*</font></td>
		  </tr>
	  <tr valign="baseline">
            <td nowrap align="right">Cell Phone:</td>
                        <td><input type="text" id="owner_phone_cell" name="owner_phone_cell" value="<?php echo $registration->owner_phone_cell; ?>" size="25" /></td>
                  </tr>
	  <tr valign="baseline" class="odd">
            <td nowrap align="right">Work Phone:</td>
                        <td><input type="text" id="owner_phone_work" name="owner_phone_work" value="<?php echo $registration->owner_phone_work; ?>" size="25" /></td>
                  </tr>
		  ...
		  <tr valign="baseline">
           ...
           <td nowrap align="right">Gender: </td>
                        <td><input type="radio" id="owner_gender_type" name="owner_gender_type" value="male" <? echo ($registration->genderType()=="MALE" ? "checked" : "") ?> /> Male
                                <input type="radio" id="owner_gender_type" name="owner_gender_type" value="female" <? echo ($registration->genderType()=="FEMALE" ? "checked" : "") ?> /> Female
 <font color="red">*</font>
                        </td>
                  </tr>
            <tr valign="baseline" class="odd">
            <td nowrap align="right">Email:</td>
                        <td><input type="text" id="owner_email" name="owner_email" value="<?php echo $registration->owner_email; ?>" size="50" /></td>
                  </tr>
		  ...
		  <tr valign="baseline">
			...
			<td><input type="text" id="bike_model" name="bike_model" value="<?php echo $registration->bike_model; ?>" size="25" /> <font color="red">*</font>
		<br />ex: RockHopper </td>
		  </tr>	
		  <tr valign="baseline" class="odd">
	...
	<tr valign="baseline">
		  ...
		  <tr valign="baseline" class="odd">
            <td nowrap align="right">Serial / Frame Number:<br /><img src="media/system/images/bicycle_serial_number_locations.JPG" alt="bicycle_serial_number_locations" width="200"></td>
			...
			<br /><img src="media/system/images/bicycle_serial_number.jpg" alt="bicycle_serial_number" width="200">
